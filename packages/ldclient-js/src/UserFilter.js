...
export default function UserFilter(config) {
  ...
  if (config.all_attributes_private !== undefined) {
    console && console.warn && console.warn(common.messages.deprecated('all_attributes_private', 'allAttributesPrivate'));
  }
  if (config.private_attribute_names !== undefined) {
    console && console.warn && console.warn(common.messages.deprecated('private_attribute_names', 'privateAttributeNames'));
  }
